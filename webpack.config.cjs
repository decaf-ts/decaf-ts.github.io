...
module.exports = (config, options) => {
  ...
  // @decaf-ts/for-angular bundles an import of '@decaf-ts/overrides/ui-decorators'.
  // That package is unpublished/monomrepo-only; alias it to ui-decorators' override
  // module for bundlers so the side-effect registration still runs.
  config.resolve.alias = config.resolve.alias || {};
  config.resolve.alias['@decaf-ts/overrides/ui-decorators'] = require('path').join(
    __dirname,
    'node_modules',
    '@decaf-ts',
    'ui-decorators',
